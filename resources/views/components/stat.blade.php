<div>
    ...
    <div class="rounded-md overflow-hidden border border bg-white flex-1">
        ...
        <a href="{{ $to }}" class="bg-gray-100 flex px-6 py-2 justify-between items-center text-sm font-bold text-indigo-500">
            View all
